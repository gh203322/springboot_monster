...
$(function () {
    ...
    function setup() {
        ...
        $('[data-skin]').on('click', function (e) {
            ...
            //(作者自定义)改变左侧菜单栏子菜单数量显示的背景
            $(".treeview small").removeClass();
            $(".treeview small").addClass("label pull-right bg-"+$(this).data('skin').split("-")[1]);
        })
    ...
    $demoSettings.append('<h4 class="control-sidebar-heading">皮肤个性化</h4>')
